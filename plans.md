...
2. Send photos as proof of the job done (Nice-to-have)
3. Trigger re-generation of a cleaning schedule
4. Swap people who are assigned on a specific week
5. Automatically charge an account 1000 SEK if the assignment was not completed on time

## Features

### Register completion of an assignment

Should only be possible for the person actually having the assignment that week.

### Trigger new generation of the schedule
...
### Automatically charge an account 1000 SEK if the assignment was not completed on time

Connect to MWL and charge 
